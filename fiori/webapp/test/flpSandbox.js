		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori App for BTP pipelines",
									"targetURL": "#btppipelinesfiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"btppipelinesfiori-display": {
								"semanticObject": "btppipelinesfiori",
								"action": "display",
								"description": "Sample read/write app",
								"title": "Fiori App for BTP pipelines",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=btp.pipelines.fiori",
									"url": sap.ui.require.toUrl("btp/pipelines/fiori")
								}
							}
						}
					}
